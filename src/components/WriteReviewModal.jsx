          ...
          >
            ...
            <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
              ...
              <div className="flex flex-col gap-1">
                ...
                <select
                  className="px-3.5 py-2.5 border border-gray-200 rounded-lg text-sm text-gray-900 bg-white outline-none transition-all focus:border-blue-500 focus:ring-2 focus:ring-blue-500/15"
              ...
              <div className="flex flex-col gap-1">
                ...
                <textarea
                  className="px-3.5 py-3 border border-gray-200 rounded-lg text-sm text-gray-900 resize-y min-h-[100px] outline-none transition-all focus:border-blue-500 focus:ring-2 focus:ring-blue-500/15"
              ...
              <button
                type="submit"
                className="self-end px-6 py-3 bg-brand-gradient text-white rounded-full text-[0.9375rem] font-semibold shadow-sm shadow-blue-500/30 transition-opacity hover:opacity-90 disabled:opacity-50 disabled:cursor-not-allowed"
                disabled={!isValid}
              >
                投稿する
              </button>
