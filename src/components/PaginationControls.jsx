...
export default function PaginationControls({ currentPage, totalPages, onPageChange }) {
  ...
  const btnHover = 'hover:border-blue-400 hover:text-blue-600 hover:bg-blue-50';
  const btnDisabled = 'disabled:opacity-40 disabled:cursor-not-allowed';
  const btnActive = 'bg-brand-gradient border-transparent text-white font-semibold shadow-sm shadow-blue-500/30 hover:opacity-90';
