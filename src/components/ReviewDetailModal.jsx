        ...
        >
          ...
          >
            ...
            <form className="flex gap-2 pt-4 border-t border-gray-200" onSubmit={handleSubmit}>
              <input
                type="text"
                className="flex-1 px-3.5 py-2.5 border border-blue-200 rounded-full text-sm outline-none transition-all focus:border-blue-500 focus:ring-2 focus:ring-blue-500/15"
                placeholder="コメントを書く..."
                value={commentText}
              ...
              <button
                type="submit"
                className="flex items-center gap-1 px-4 py-2.5 bg-brand-gradient text-white rounded-full text-[0.8125rem] font-semibold shadow-sm shadow-blue-500/30 transition-opacity hover:opacity-90 disabled:opacity-50 disabled:cursor-not-allowed"
